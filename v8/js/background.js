 ...
 */
const createCircles = function (pageHeight, pageWidth, nbCircles, widthFillingPercentage, maxCircleSizeInPercentage) {
...
export default function initBackground () {
  ...
  createCircles(height, width, 50, 50, circleSizeInWidthViewPortPercentage)
}
